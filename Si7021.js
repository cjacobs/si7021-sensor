...
class Si7021 {
  ...
  constructor(options) {
    ...
    // Command table (taken from datasheet at https://cdn-learn.adafruit.com/assets/assets/000/035/931/original/Support_Documents_TechnicalDocs_Si7021-A20.pdf)
    this.SI7021_MEASURE_HUM_HOLD_CMD    = 0xE5;
    this.SI7021_MEASURE_HUM_NOHOLD_CMD  = 0xF5;
    this.SI7021_MEASURE_TEMP_HOLD_CMD   = 0xE3;
    this.SI7021_MEASURE_TEMP_NOHOLD_CMD = 0xF3;
    this.SI7021_READ_PREV_TEMP_CMD      = 0xE0;
    this.SI7021_RESET_CMD               = 0xFE;
    this.SI7021_WRITERHT_REG_CMD        = 0xE6;
        ...
        setTimeout(() => {
          this.i2cBus.readByte(this.SI7021_ADDRESS, this.SI7021_READRHT_REG_CMD, (err, userRegister) => {
            ...
            if(userRegister !== this.SI7021_USER_REG_DEFAULT) {
              reject(`User register returned 0x${userRegister.toString(16)}. Expected 0x${this.SI7021_USER_REG_DEFAULT.toString(16)} after reset.`);
            }
